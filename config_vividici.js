...
var init_phones = ["Jays Audio"],                             // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      watermark_text = "vividici",                 // Optional. Watermark appears behind graphs
...
function watermark(svg) {
    ...
    if ( watermark_image_url ) {
        wm.append("image")
            .attrs({x:-90, y:-71, width:160, height:160, "xlink:href":watermark_image_url});
    }
...
let targets = [
    // { type:"Preference",   
	//     files:["Bad Guy","Jays Audio","MMagTech","nymz","PaulWasabi","Precogvision","Rtings","Sonarworks","Super Review 21","Super Review 22"] },
    // { type:"Reference", 
